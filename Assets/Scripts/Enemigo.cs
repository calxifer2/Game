...
public class Enemigo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("�Error! No se encontr� el objeto del jugador.");
        }
    ...
    void Morir()
    {
        ...
        // Verificar si el Animator tiene el par�metro "Morir"
        ...
        {
            Destroy(gameObject, 1f); // Destruir si no tiene la animaci�n "Morir"
        }

        // M�todo para verificar si el Animator tiene un par�metro espec�fico
        ...
        // Llamar al GameManager para aumentar la puntuaci�n
        Score.instance.IncreaseScore(scoreValue);

        // Aumentar la vida del jugador si no excede su vida m�xima
        if (player != null)
        {
            player.IncreaseHealth(15); // Ajusta el valor de aumento seg�n sea necesario
        }
    }
